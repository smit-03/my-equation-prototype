      ...
      >
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <div className="flex items-center">
            ...
            <Typography variant="h2" className="mb-0 text-2xl font-bold text-primary-default">
              Company Name
            </Typography>
          </div>
                ...
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 font-normal transition-colors hover:text-primary-light"
                    >
                      {link}
                    </Typography>
                  </li>
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-gray-700 md:mb-0"
          >
            &copy; {currentYear}{' '}
            <a href="https://material-tailwind.com/" className="text-primary-default">
              Company Name
            </a>
            . All Rights Reserved.
          </Typography>
